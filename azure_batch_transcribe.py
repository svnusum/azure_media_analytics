...
SPEECH_SERVICE_SUBSCRIPTION_KEY = os.getenv("SPEECH_SERVICE_SUBSCRIPTION_KEY")
SPEECH_SERVICE_REGION = config_details['SPEECH_SERVICE_REGION']
...
def transcribe(RECORDINGS_BLOB_URI):
    ...
    logging.info(f"Created new transcription with id '{transcription_id}' in region {SPEECH_SERVICE_REGION}")
    ...
    while not completed:
        ...
        if transcription.status == "Succeeded":
            ...
            for file_data in _paginate(api, pag_files):
                ...
                output = json.loads(results.content.decode('utf-8'))
                final_output = output['combinedRecognizedPhrases'][0]['display']
                #logging.info(f"Results for {audiofilename}:\n{final_output}")
                return final_output
